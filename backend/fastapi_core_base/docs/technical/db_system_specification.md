...
*   **Postgres Native ([asyncpg](file:///Users/abhisheksingh/Documents/Development/stack-foundations/backend/fastapi_core_base/src/shared/db/engines/postgres.py))**: Primary engine for low-latency CRUD and binary protocols.
...
### B. Intelligent Connection Manager ([PostgresConnection](file:///Users/abhisheksingh/Documents/Development/stack-foundations/backend/fastapi_core_base/src/shared/db/core/connection_manager.py))
*   **Dual-Pooling Strategy**: Separate managed pools for [asyncpg](file:///Users/abhisheksingh/Documents/Development/stack-foundations/backend/fastapi_core_base/src/shared/db/engines/postgres.py) (Native) and `SQLAlchemy` (ORM).
...
### D. Adaptive Execution Engine (Four Execution Lanes in `src/shared/db/execution_lanes/`)
*   **Heuristic Detection**: Automatically detects `read` vs `write` operations.
*   **Memory Intelligence**: Uses `psutil` to sense system RAM; automatically switches to [stream](file:///Users/abhisheksingh/Documents/Development/stack-foundations/backend/fastapi_core_base/src/shared/db/execution_lanes/transactional.py) mode if RAM < 0.5GB.
...
*   [asyncpg](file:///Users/abhisheksingh/Documents/Development/stack-foundations/backend/fastapi_core_base/src/shared/db/engines/postgres.py): Native driver for Postgres.
